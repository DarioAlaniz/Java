...
public class Personaje {
    ...
    public void tomarElemento (String nombre) {
        if(getElemento()!=null){
            ...
            if(getBolsa().getElemento(nombre)==null){
                System.out.println("No se cuenta con el "+ nombre);
            }
            else {
                setElemento(getBolsa().getElemento(nombre));
            }
        }
    }
    ...
    public void recogerElemento (String nombre) {
        if(habitacion.getElemento(nombre)==null){
            // setElemento(getElemento());
        }
        else {
            if(getElemento()!=null){
                guardarElemento();
                setElemento(habitacion.getElemento(nombre));
            }
            else{
                setElemento(habitacion.getElemento(nombre));
            }
    ...
    public void dejarElemento () {
        if(getElemento()==null){
            ...
            habitacion.addElemento(getElemento());
            setElemento(null);
        }
    }
