...
/* Informatica Avanzada - 2021 */
    ...
    {
        Strign cadena = "Usted esta en la "+ getNombre() + "\n";
        cadena += getStringDeSalidas() + "\n";
        cadena += getStringDeElementos();
        return cadena;
    }
    ...
    public Elemento getElemento (String nombre) {
        ...
        else if(!elementos.containsKey(nombre)){
            System.out.println(nombre+": "+"No existe");
            return null;
        }
        if(elementos.get(nombre).getTipo()==TipoElemento.FIJO){
    ...
    public Habitacion getSalida (Salida direccion) 
    {
        ...
        System.out.println("No hay salidas en direccion "+ direccion);
        return this;
    }
